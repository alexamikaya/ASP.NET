...
runat="server"></asp:TextBox>
 ...
 <asp:TextBox ID="chem" runat="server" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="chem" ErrorMessage="Заполните поле">Заполните поле</asp:RequiredFieldValidator>
 </div>
