<%@ Page Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Fiveworse.aspx.cs" Inherits="Final.Fiveworse" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
       <div>
    <h1>Пять худших студентов</h1>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Studentsmark %>" SelectCommand="SELECT TOP(5) [StudentName], [StudentRussia], [StudentMath], [StudentChem], (convert (int, StudentChem) + convert (int, StudentRussia) + convert (int, StudentMath)) as SumMarks FROM GuestResponses ORDER BY SumMarks"></asp:SqlDataSource>
    </div>
</asp:Content>
